...
<template>
    <div>
        ...
        <div :class="`modal ${!openDelete && 'opacity-0 pointer-events-none'
            } z-50 fixed w-full h-full top-0 left-0 flex items-center justify-center`">
            <div class="absolute w-full h-full bg-gray-900 opacity-50 modal-overlay" @click="openDelete = false" />
            ...
            <div class="z-50 w-11/12 mx-auto overflow-y-auto bg-white rounded-xl shadow-lg modal-container md:max-w-md">
                ...
                <div class="px-6 py-4 text-left modal-content">
                    <div class="flex items-center justify-between pb-3">
                        ...
                        <div class="z-50 cursor-pointer modal-close" @click="openDelete = false">
